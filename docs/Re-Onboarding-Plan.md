...
- Parsed all 38 PowerShell sources and passed all nine test scripts in both PowerShell 7 and Windows PowerShell 5.1. The required encode environment preflight reports `READY`.
