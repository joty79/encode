...
- Keep TS folder analysis bounded to 1–4 whole-file workers. Preserve deterministic filename-ordered reporting, isolate per-file failures, and move a problem file only after its classification completes; never split one TS into timeline chunks.
